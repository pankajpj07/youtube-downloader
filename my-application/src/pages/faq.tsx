        ...
        <div className="grid gap-8">
          <div>
            ...
            <p>
              ...
              the {companyName} website, and click the "Download" button. Choose
              the file format and resolution you want, and the video will be
          ...
          <div>
            ...
            <p>
              ...
              videos from their platform. However, whether or not it is legal to
              do so depends on the laws in your country. It is your
              responsibility to ensure that you comply with all applicable laws
              and regulations.
            </p>
          </div>
          <div>
            ...
            <p>
              No, {companyName} does not condone the downloading of copyrighted
              material without permission. It is your responsibility to ensure
              that you only download videos that you have the right to use.
            </p>
          </div>
          <div>
            <h2 className="text-lg font-bold mb-2">
            ...
            <p>
              Yes, you can use {companyName} to download videos from YouTube on
              your mobile device by accessing the {companyName} website through
              your mobile browser.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              file formats and resolutions. If you want to convert a video to a
              different file format after downloading, you can use third-party
              video conversion software or websites.
            </p>
          </div>
          <div>
            <h2 className="text-lg font-bold mb-2">
          ...
          <div>
            <h2 className="text-lg font-bold mb-2">
              What is the maximum video resolution that can be downloaded using{" "}
              {companyName}?
            </h2>
            <p>
          ...
          <div>
            ...
            <p className="mb-4">
              ...
              videos from YouTube. However, we may display ads or offer premium
          ...
          <div>
            ...
            <p className="mb-4">
              ...
              use our service. However, creating an account may offer additional
              benefits such as faster download speeds and the ability to
          ...
          <div>
            ...
            <p className="mb-4">
              ...
              However, we cannot guarantee the safety of third-party websites or
              the content that users download.
            </p>
          </div>
        </div>
      </div>
