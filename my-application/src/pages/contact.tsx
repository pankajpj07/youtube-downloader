  ...
  return (
   ...
   <div className="bg-gray-100 py-12 px-4">
      ...
      <Head>
        ...
        <meta name="description" content="Contact Utubeloader support for assistance." />
      </Head>
      <div className="px-4 md:px-8 py-10 md:py-16 max-w-screen-md mx-auto">
        <h1 className="text-3xl font-bold mb-6">Contact Us</h1>
        <p className="text-lg mb-6">
          The only way to reach us is through email: <a className="text-blue-600" href="mailto:support@utubeloader.com">support@utubeloader.com</a>
        </p>
        <p className="text-lg mb-6">
